...
public class Producto extends javax.swing.JFrame {
    ...
    private void tblTablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTablaMouseClicked
        ...
        if(fila==-1){
            ...
            String codigo = ((String)tblTabla.getValueAt(fila, 0).toString());
            String nombre = (String)tblTabla.getValueAt(fila, 1);
            String cantidad = ((String)tblTabla.getValueAt(fila, 2).toString());
            String precio = ((String)tblTabla.getValueAt(fila, 3).toString());
